...
#define mRTOS_APPLICATION_TASKS 3               // количество пользовательских задач в приложении
#define mRTOS_MAX_EVENTS        0               // количество событий в приложении
...
#define mRTOS_DISPATCH  mRTOS_DispatchTask(&mRTOS_Tasks[mRTOS_CurrentTask].Context) // вызов функции диспетчера задач
#define mRTOS_TASK_WAIT(d)  mRTOS_WaitTask(d, &mRTOS_Tasks[mRTOS_CurrentTask].Context) // вызов функции перевода текущей задачи в состояние Wait на время d тиков (d = 0 .. 65535)
#define mRTOS_TASK_ACTIVE(n)  mRTOS_SetTaskNStatus(n, ACTIVE) // вызов функции перевода задачи под номером n в состояние Active
#define mRTOS_TASK_STOP  {mRTOS_SetTaskStatus(STOP); mRTOS_DISPATCH;} // вызов функции перевода текущей задачи в состояние Stop с последующим вызовом диспетчера задач
